...
public class ProfilesTest {
    List<Profile> list = List.of(
            ...
            new Profile(new Address("Small City", "Central Street", 2, 5)),
            new Profile(new Address("Small City", "Short Street", 3, 6)),
            new Profile(new Address("Big City", "River Street", 4, 7))
            );
    ...
    public void whenAddressListReturned() {
        ...
        List<Address> expected = List.of(
                ...
                new Address("Small City", "Central Street", 2, 5),
                new Address("Small City", "Short Street", 3, 6),
                new Address("Big City", "River Street", 4, 7)
        );
        assertThat(result, is(expected));
    }
    @Test
    public void whenUniqueAddressListReturned() {
        Profiles profiles = new Profiles();
        List<Address> result = profiles.uniqueAddressCollect(list);
        List<Address> expected = List.of(
                new Address("Big City", "Long Street", 1, 1),
                new Address("Big City", "River Street", 4, 7),
                new Address("Small City", "Central Street", 2, 5),
